...
export function P2PBalanceWarning() {
  ...
  return (
    <Alert
      aria-live="polite"
      className="flex flex-col gap-3 rounded-none border-transparent px-4 py-4 bg-[#2d1820] text-white md:flex-row md:items-center md:gap-4 md:rounded-2xl md:bg-error-light md:text-grayscale-100 md:px-6 md:pt-6 md:pb-12"
    >
