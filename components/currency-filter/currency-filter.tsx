...
export function CurrencyFilter({
  ...
  const CurrencyList = () => (
    <div className="w-full h-full">
      ...
      <div className="max-h-[80%] overflow-y-auto [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none] md:pr-2 md:mr-2 md:relative md:left-[-16px] md:w-[calc(100%+32px)]">
