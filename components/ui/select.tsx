  ...
  >
    ...
    <SelectPrimitive.Icon asChild>
      <Image
        ...
        width={18}
        height={14}
        className="opacity-70 ml-[8px] data-[state=open]:hidden"
      />
    ...
    <SelectPrimitive.Icon asChild>
      <Image
        ...
        width={18}
        height={14}
        className="opacity-70 ml-[8px] hidden data-[state=open]:block"
      />
    </SelectPrimitive.Icon>
  </SelectPrimitive.Trigger>
))
...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.ScrollUpButton
    ...
    {...props}
  >
    <Image src="/icons/chevron-up.png" alt="Scroll up" width={12} height={8} className="opacity-70" />
  </SelectPrimitive.ScrollUpButton>
))
