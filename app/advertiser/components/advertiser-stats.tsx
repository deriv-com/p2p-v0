...
export default function AdvertiserStats({ profile }: AdvertiserStatsProps) {
  ...
  return (
    <TooltipProvider>
      <div>
        <div className="flex flex-col items-start md:flex-row md:items-center md:justify-between gap-4 mx-[-24px] p-6 border-b mb-4 md:mx-0 md:p-0 md:border-none md:mb-0 py-6">
