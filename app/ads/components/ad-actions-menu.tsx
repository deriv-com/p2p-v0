  ...
  return (
    <>
      <Button
        ...
        onClick={() => onEdit(ad)}
      >
        <Image className="me-2" src="/icons/edit.svg" alt="Edit" width={14} height={16} />
        {t("myAds.edit")}
      </Button>
      <Button
        variant="ghost"
        ...
        onClick={() => onShare(ad)}
      >
        <Image className="me-2" src="/icons/share-icon.svg" alt="Share" width={14} height={16} />
        {t("myAds.share")}
      </Button>
      <Button
        variant="ghost"
      ...
      >
        <Image className="me-2" src="/icons/deactivate.svg" alt="Toggle status" width={14} height={16} />
      ...
      >
        <Image className="me-2" src="/icons/delete.svg" alt="Delete" width={14} height={16} />
