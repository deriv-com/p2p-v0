        ...
        <Table>
          ...
          <TableBody className="bg-white lg:divide-y lg:divide-slate-200 font-normal text-sm">
            {Array.from({ length: 3 }).map((_, index) => (
              <TableRow
                key={index}
                className="grid grid-cols-[2fr_1fr] lg:flex flex-col border-b mb-[16px] lg:table-row lg:border-x-[0] lg:border-t-[0] lg:mb-[0] py-3 lg:p-0"
              >
            ...
            {ads.map((ad, index) => {
              ...
              return (
                <TableRow
                  key={index}
                  className={cn(
                    "grid grid-cols-[2fr_1fr] lg:flex flex-col border-b mb-[16px] lg:table-row lg:border-x-[0] lg:border-t-[0] lg:mb-[0] py-3 lg:p-0",
                  )}
                >
                  <TableCell
                    className={cn(
