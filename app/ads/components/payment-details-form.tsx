    ...
    <>
      {isMobile && (
        <div className="px-6 pb-4 text-center">
          <p className="text-base text-black/70">{t("paymentMethod.selectUpTo3")}</p>
        </div>
      )}
      <div className={isMobile ? "px-6 pb-4" : ""}>
        <div className="relative">
          ...
          <Input
            ...
            className="text-base pl-10 pr-10 h-8 md:h-14 bg-black/5 border-0 focus:border-0 focus:ring-0 rounded-lg placeholder:text-black/25 placeholder:text-base placeholder:font-normal"
          />
        </div>
      </div>
      {!isMobile && (
        <div className="my-0">
          <p className="text-base text-gray-900">{t("paymentMethod.selectUpTo3")}</p>
        </div>
      )}
              ...
              >
                ...
                <div onClick={(e) => e.stopPropagation()}>
                  <Checkbox
                    ...
                    className="w-[14px] h-[14px] data-[state=checked]:bg-black border-2 border-black/50 rounded-[2px]"
                  />
                </div>
              </div>
            )
  ...
  return (
    <div className="flex flex-col h-full md:h-[60vh] md:max-h-[600px]">
      <div className="flex-1 overflow-y-auto space-y-4 pb-4">
        {paymentMethods && <div className="text-black/70">{t("paymentMethod.selectUpTo3")}</div>}
