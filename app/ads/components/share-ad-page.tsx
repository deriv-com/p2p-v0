      ...
      <div className="flex flex-col h-full max-w-xl mx-auto">
        ...
        <div className="flex-1 overflow-y-auto">
          ...
          <div className="flex items-center flex-col py-6 space-y-6">
            <div ref={cardRef} className="w-[358px] bg-primary py-6 px-8 text-white">
              <div className="mb-6">
            ...
            <div className="flex">
              ...
              <Button
                ...
                className="flex flex-col items-center gap-2 rounded-lg hover:bg-gray-50 transition-colors min-w-fit min-h-fit"
              >
                <div className="w-[60px] p-2 rounded-full flex items-center justify-center">
