          ...
          isMobile ? (
            ...
            <Select value={value} onValueChange={handleSelect} disabled={disabled}>
              ...
              <SelectContent className="cursor-pointer">
                <SelectItem value="fixed" className="[&:hover>div]:bg-black [&:hover>div]:border-black [&:hover_span:first-child]:text-white [&:hover_span:last-child]:text-white/72 data-[state=checked]:*:bg-black data-[state=checked]:*:border-black [&[data-state=checked]_span:first-child]:text-white [&[data-state=checked]_span:last-child]:text-white/72">
                  <div className="flex flex-col rounded-lg transition-all text-slate-1200 w-full hover:bg-black hover:border-black hover:[&>span:first-child]:text-white hover:[&>span:last-child]:text-white/72">
