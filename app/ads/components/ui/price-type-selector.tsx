          ...
          isMobile ? (
            ...
            <Select value={value} onValueChange={handleSelect} disabled={disabled}>
              ...
              <SelectContent className="[&_[role=option]>div]:bg-white">
                <SelectItem value="fixed" className="bg-white hover:bg-slate-1200 [&[data-state=checked]>div]:border-black [&[data-state=checked]_span:first-child]:text-slate-1200 [&[data-state=checked]_span:last-child]:text-grayscale-600 hover:[&_span:first-child]:text-white hover:[&_span:last-child]:text-white hover:[&_span:last-child]:opacity-72 cursor-pointer">
                ...
                <SelectItem value="float" className="bg-white hover:bg-slate-1200 [&[data-state=checked]>div]:border-black [&[data-state=checked]_span:first-child]:text-slate-1200 [&[data-state=checked]_span:last-child]:text-grayscale-600 hover:[&_span:first-child]:text-white hover:[&_span:last-child]:text-white hover:[&_span:last-child]:opacity-72 cursor-pointer">
                  <div className="flex flex-col">
