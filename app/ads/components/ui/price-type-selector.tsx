          ...
          isMobile ? (
            ...
            <Select value={value} onValueChange={handleSelect} disabled={disabled}>
              ...
              <SelectContent className="[&>*]:!p-0 [&_[role=option]>div]:bg-grayscale-500 [&_[role=option]>div]:border-grayscale-500">
                <SelectItem value="fixed" className="!py-0 !px-0 [&:span:first-child]:text-white [&:span:last-child]:text-white/72 [&:hover>div]:bg-black [&:hover>div]:border-black [&:hover_span:first-child]:text-white [&:hover_span:last-child]:text-white/72 [&[data-state=checked]>div]:bg-black [&[data-state=checked]>div]:border-black [&[data-state=checked]_span:first-child]:text-white [&[data-state=checked]_span:last-child]:text-white/72" data-testid="fixed-item">
                ...
                <SelectItem value="float" className="!py-0 !px-0 [&:span:first-child]:text-white [&:span:last-child]:text-white/72 [&:hover>div]:bg-black [&:hover>div]:border-black [&:hover_span:first-child]:text-white [&:hover_span:last-child]:text-white/72 [&[data-state=checked]>div]:bg-black [&[data-state=checked]>div]:border-black [&[data-state=checked]_span:first-child]:text-white [&[data-state=checked]_span:last-child]:text-white/72" data-testid="float-item">
                  <div className="flex flex-col p-4 rounded-xl border border-grayscale-500 bg-grayscale-500 cursor-pointer transition-all text-slate-1200 w-full">
