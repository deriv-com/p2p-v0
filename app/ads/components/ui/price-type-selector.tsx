        ...
        {marketPrice && isFloatingRateEnabled && (
          isMobile ? (
            ...
            <Select value={value} onValueChange={handleSelect} disabled={disabled}>
              ...
              <SelectContent className="[&_[role=option]>div]:bg-white">
                <SelectItem value="fixed" className="bg-white data-[state=checked]:bg-black hover:bg-black [&_span:first-child]:!text-slate-1200 [&_span:last-child]:!text-grayscale-600 data-[state=checked]:[&_span:first-child]:!text-white data-[state=checked]:[&_span:last-child]:!text-white data-[state=checked]:[&_span:last-child]:!opacity-72 hover:[&_span:first-child]:!text-white hover:[&_span:last-child]:!text-white hover:[&_span:last-child]:!opacity-72 cursor-pointer">
                ...
                <SelectItem value="float" className="bg-white data-[state=checked]:bg-black hover:bg-black [&_span:first-child]:!text-slate-1200 [&_span:last-child]:!text-grayscale-600 data-[state=checked]:[&_span:first-child]:!text-white data-[state=checked]:[&_span:last-child]:!text-white data-[state=checked]:[&_span:last-child]:!opacity-72 hover:[&_span:first-child]:!text-white hover:[&_span:last-child]:!text-white hover:[&_span:last-child]:!opacity-72 cursor-pointer">
                  <div className="flex flex-col">
