  ...
  return (
    <>
      ...
      <div className="fixed w-full h-full bg-white top-0 left-0 md:px-[24px]">
        <div className="md:max-w-[600px] mx-auto pb-12 mt-0 md:mt-8 progress-steps-container overflow-auto h-full md:px-0">
          <Navigation
          ...
          />
          <div className="hidden md:block text-2xl font-bold m-4 mb-10">{getPageTitle(formData.type)}</div>
