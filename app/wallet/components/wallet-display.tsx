...
export default function WalletDisplay({ name, amount, currency, icon, onClick }: WalletDisplayProps) {
  return (
    <div
      className="min-h-[56px] px-4 py-2 flex items-center self-stretch rounded-lg border border-black/[0.04] bg-[#EFF3F5] cursor-pointer hover:bg-gray-100 transition-colors"
      onClick={onClick}
    >
