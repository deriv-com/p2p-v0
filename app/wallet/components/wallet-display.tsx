...
export default function WalletDisplay({ name, amount, currency, icon, onClick }: WalletDisplayProps) {
  return (
    <div
      className="min-h-[56px] px-6 py-2 flex items-center self-stretch rounded-lg border border-black/[0.04] bg-[#EFF3F5] cursor-pointer hover:bg-gray-100 transition-colors"
      onClick={onClick}
    >
      <div className="w-8 h-8 flex-shrink-0 ml-4">
