              ...
              <div className="flex-1 md:block md:flex-none">
                <PaymentMethodsFilter
                  ...
                  trigger={
                    <Button
                      variant="outline"
                      className="rounded-md border border-input font-normal w-full min-h-[32px] h-[32px] lg:min-h-[40px] lg:h-[40px] justify-between hover:bg-transparent max-w-[195px]"
                    >
