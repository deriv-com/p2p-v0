        ...
        <div className="flex-shrink-0">
          <div className="mb-4 md:mb-6 md:flex md:flex-col justify-between gap-4">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
              <div className="w-full h-[72px] md:h-[80px] flex flex-row items-start md:items-center gap-[16px] md:gap-[24px] bg-slate-1200 p-6 rounded-t-3xl md:rounded-3xl -mx-3 md:mx-0  justify-between">
                <Tabs
                  value={activeTab}
