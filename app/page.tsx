                ...
                <div>
                  ...
                  <CurrencyFilter
                    ...
                    trigger={
                      <Button
                        variant="outline"
                        className="rounded-md border border-input bg-background font-normal min-h-[32px] h-[32px] lg:min-h-[40px] lg:h-[40px] px-3 bg-transparent rounded-3xl focus:border-black"
                      >
                        <span>{currency}</span>
