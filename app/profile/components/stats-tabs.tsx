      ...
      <div className="mb-[64px] md:mb-6">
        {isMobile ? (
          ...
          <Tabs defaultValue={activeTab}>
            ...
            <TabsContent value="payment" className="mt-4 h-[calc(100vh-350px)] overflow-y-auto">
              <div className="relative">
                {paymentMethodsCount > 0 && (
            ...
            <TabsContent value="follows" className="mt-4 h-[calc(100vh-350px)] overflow-y-auto">
              <div className="relative">
                <FollowsTab />
              </div>
            </TabsContent>

            <TabsContent value="blocked" className="mt-4 h-[calc(100vh-350px)] overflow-y-auto">
              <div className="relative">
                <BlockedTab />
              </div>
            </TabsContent>
