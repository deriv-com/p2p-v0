...
export default function UserInfo({
  ...
  return (
    <div className="w-full md:w-full flex flex-row items-center gap-[16px] md:gap-[24px] bg-slate-1200 p-6 rounded-b-3xl md:rounded-3xl justify-between mb-0 md:mb-4 md:mx-0 md:mt-0">
